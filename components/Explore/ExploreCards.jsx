...
const ExploreCards = ({ name, api }) => {
  ...
  return (
    <div className="w-[100%] h-[90%] flex">
      <div className="w-[100%] h-[100%] flex flex-col flex-wrap  overflow-x-scroll scrollbar-hide pr-5 space-x-3  lg:space-x-6  lg:px-3 pt-3 overflow-y-hidden lg:pt-0">
        {podcasts.map((podcast) => (
          <div className="w-40 h-[100%]  sm:w-56 sm:h-[100%]  hover:cursor-pointer space-y-2  sm:space-y-3 ">
            <div className="w-40 h-[80%] sm:w-[100%] sm:h-[80%] rounded-xl relative   overflow-hidden transform transition duration-500 hover:scale-105">
              <Image src={podcast.image} fill alt="podcast-cards" />
            </div>
            <div className="w-40 h-[20%] sm:w-[100%] sm:h-[20%]flex flex-col text-sm space-y-1">
